...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.LastInsertIdMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.LockByExampleMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.LockByPrimaryKeyMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.PageByExampleMethodGenerator;
...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
         ...
         * Silver
         */
        addLockByPrimaryKeyMethod(interfaze);
        /**
         * Silver
         */
        addLockByExampleMethod(interfaze);
        /**
         * Silver
         *//*
        addPageByExampleMethod(interfaze);*/
        /**
         * Silver
         */
        addLastInsertIdMethod(interfaze);
    ...
    /**
     * @author Silver 
     * @date 2016年8月16日 上午10:53:11
     */
    protected void addLockByPrimaryKeyMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateLockByPrimaryKey()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new LockByPrimaryKeyMethodGenerator(false);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    } 
    /**
     ...
     * @date 2016年8月16日 上午10:53:11
     */
    protected void addLockByExampleMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateLockByExample()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new LockByExampleMethodGenerator(false);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
    /**
     ...
     * @date 2016年8月16日 上午10:53:11
     *//*
    protected void addPageByExampleMethod(Interface interfaze) {
        if (introspectedTable.getRules().generatePageByExample()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new PageByExampleMethodGenerator(false);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }*/
     ...
     * @date 2016年8月16日 上午10:53:11
     */
    protected void addLastInsertIdMethod(Interface interfaze) {
        if (introspectedTable.getRules().generateLastInsertId()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new LastInsertIdMethodGenerator(false);
            initializeAndExecuteGenerator(methodGenerator, interfaze);
        }
    }
