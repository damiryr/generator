...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.LastInsertIdElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.LockByExampleElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.LockByPrimaryKeyElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.PageByExampleElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
         ...
         * Silver
         */
        addLockByPrimaryKeyElement(answer);
        /**
         * Silver
         */
        addLockByExampleElement(answer);
        
        /**
         * Silver
         *//*
        addPageByExampleElement(answer);*/
        /**
         * Silver
         */
        addLastInsertIdElement(answer);
    ...
    /**
     * @author Silver 
     * @date 2016年8月16日 上午10:24:16
     */
    protected void addLockByPrimaryKeyElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateLockByPrimaryKey()) {
            AbstractXmlElementGenerator elementGenerator = new LockByPrimaryKeyElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }  
    /**
     ...
     * @date 2016年8月16日 上午10:24:16
     */
    protected void addLockByExampleElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateLockByExample()) {
            AbstractXmlElementGenerator elementGenerator = new LockByExampleElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
     ...
     * @date 2016年8月16日 上午10:24:16
     */
    /*protected void addPageByExampleElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generatePageByExample()) {
            AbstractXmlElementGenerator elementGenerator = new PageByExampleElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }*/
     ...
     * @date 2016年8月16日 上午10:24:16
     */
    protected void addLastInsertIdElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateLastInsertId()) {
            AbstractXmlElementGenerator elementGenerator = new LastInsertIdElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
